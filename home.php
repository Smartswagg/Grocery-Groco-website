...
// No forced login redirect on home page
...
<div class="home-bg">
   ...
   <section class="home">
      ...
      <div class="content">
         ...
         <h3>Reach For A Healthy Lifestyle With Organic Foods</h3>
         <p>From crisp, juicy apples to leafy greens bursting with freshness, organic farming practices enhance taste by working with nature, not against it. Even pantry staples like grains</p>
...
<section class="products">
   ...
   <?php
      $select_products = $conn->prepare("SELECT * FROM `products` WHERE status = 'approved' LIMIT 6");
